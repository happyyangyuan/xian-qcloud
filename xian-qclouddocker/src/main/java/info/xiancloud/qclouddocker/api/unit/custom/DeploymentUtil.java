...
public class DeploymentUtil {
     ...
     */
    static Single<List<String>> allServicesInCluster(String clusterId, String namespace) {
        List<String> serviceNames = new ArrayList<>();
        return SingleRxXian.call(DescribeClusterServiceUnit.class,
                new JSONObject() {{
            ...
            JSONArray services = unitResponse.dataToJson().getJSONObject("data").getJSONArray("services");
